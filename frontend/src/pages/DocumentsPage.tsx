              ...
              <tr key={doc.id}>
                ...
                <td>
                  <div style={{ display: 'flex', gap: 6 }}>
                    <a href={`${(import.meta.env.VITE_API_URL || 'http://localhost:3001').replace('/api', '')}/uploads/${doc.filePath}`} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm"><Download size={13} /></a>
